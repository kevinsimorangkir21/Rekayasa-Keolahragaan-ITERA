...
export default function FeedbackMentor() {
  const [feedbacks, setFeedbacks] = useState([
    {
      ...
      rating: 5,
      komentar: "Mentor sangat membantu dan komunikatif selama proses magang.",
      tanggal: "2025-10-18",
    },
  ]);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!newFeedback.mentor || newFeedback.rating === 0 || !newFeedback.komentar)
    ...
    setNewFeedback({ mentor: "", rating: 0, komentar: "" });
    e.target.reset();
  };
    ...
    <div className="space-y-10">
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Berikan penilaian dan masukan untuk mentor agar program magang semakin baik.
        </p>
      </motion.div>
      ...
      >
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Tulis pengalamanmu bersama mentor..."
            className="w-full p-3 rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-[#0b0f15] text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:outline-none"
          ></textarea>
        </div>
            ...
            {feedbacks.map((fb) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <h3 className="font-semibold text-blue-600 dark:text-blue-400">{fb.mentor}</h3>
